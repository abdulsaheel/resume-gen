...
import featureUSSrc from "public/assets/flag.png";
...
const FEATURES = [
 
  {
    ...
    text: "Portfolio Builder has built-in best practices for the Indian job market and works well with top ATS platforms such as Greenhouse and Lever",
  },
  {
    src: featurePrivacySrc,
    title: "Privacy Focus",
    text: "Portfolio Builder stores data locally in your browser so only you have access to your data and with complete control",
  },
